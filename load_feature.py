...
def chain_feature(result_path):
    ...
    for chain in ['A', 'B']:
        ...
        feature_1d = np.hstack((PSSM, esm1b_repr, msa1b_repr)).T
        feature_1d = torch.from_numpy(feature_1d)
        chain_feature.append(feature_1d)
...
def paired_feature(result_path):
    ...
    rtattn_esm1b = os.path.join(result_path, 'esm1b_rt.attn.npy')
    rtattn_msa1b = os.path.join(result_path, 'msa1b_rt.attn.npy')
    swattn_esm1b = os.path.join(result_path, 'esm1b_sw.attn.npy')
    swattn_msa1b = os.path.join(result_path, 'msa1b_sw.attn.npy')
    
    
    rtattn_esm1b = np.load(rtattn_esm1b)
    l,h,la,lb = rtattn_esm1b.shape
    rtattn_esm1b = np.reshape(rtattn_esm1b, (l*h,la,lb))
    ...
    swattn_esm1b = np.load(swattn_esm1b)
    l,h,la,lb = swattn_esm1b.shape
    swattn_esm1b = np.reshape(swattn_esm1b, (l*h,la,lb))
    ...
    rt_feature_2d = [ccmpred, alnstats, rtattn_esm1b, rtattn_msa1b]
    ...
    sw_feature_2d = [ccmpred.swapaxes(-2,-1), 
                     alnstats.swapaxes(-2,-1), 
                     swattn_esm1b, swattn_msa1b]
